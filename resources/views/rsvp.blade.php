...
<head>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-PRJ6T78C');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PRJ6T78C"
        ...
        <form id="ticketForm" class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-600">
                    Note: Children must be 14 years old or younger. Guests over 14 years should get their own invite.
                </p>
            </div>
...
{{--                <h2 class="text-gray-800 text-lg font-semibold text-center mb-4">Download your invitation card</h2>--}}
                ...
                <div class="w-full max-w-sm mb-6">
                    <div class="rounded-2xl px-4 py-4 flex items-center justify-between border border-[#C9B0B0]">
                        ...
                        <button class="copy-btn text-maroon p-2 hover:bg-rose-medium rounded-lg transition" data-copy="SHIKEO-2537" id="codeButton">
